...
export function runCreativeProductionRuntime(input) {
  ...
  const calibrationReady = [productUnderstanding.reviewReady, inspirationReady, referenceSystem.pass, designRead.pass, creativeDials.pass, exploration.pass, selection.pass].every(Boolean);
  ...
  const stages = [
    'product-understanding', 'inspiration', 'reference-extraction', 'design-read', 'creative-dials', 'explore', 'concept-selection',
