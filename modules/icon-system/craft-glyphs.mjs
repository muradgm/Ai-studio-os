...
function qShape(iconId, size) {
  ...
  const shapes = {
    ...
    provenance: v === 'micro'
      ? '<g id="base"><path d="M4 8H9V12H15V16H20"/><path d="M7 6V10M17 14V18"/></g>'
      : '<g id="base"><path d="M4 7H9V11H15V17H20"/><path d="M6 5V9M18 15V19"/></g><g id="semantic-mark"><path d="M11 9L13 11M13 15L15 17"/></g>',
    memory: v === 'micro'
    ...
    authority: '<g id="base"><path d="M12 4V20M4 9H9M15 15H20"/></g><g id="semantic-mark"><path d="M9 7V11M15 13V17"/></g>',
...
function eShape(iconId, size) {
  ...
  const shapes = {
    ...
    provenance: v === 'micro'
      ? '<g id="base"><path d="M5 9V6H8M16 18H19V15M8 12C10 9 14 15 16 12"/></g>'
      : '<g id="base"><path d="M5 9V5H9M15 19H19V15M8 12C10 8 13 9 15 12C16 13.5 17 13.5 18 12"/></g>',
    memory: v === 'micro'
    ...
    authority: '<g id="base"><path d="M12 4C11 8 13 10 12 12C11 14 13 16 12 20M4 9H9M15 15H20"/></g>',
    verification: v === 'micro'
...
function pShape(iconId, size) {
  ...
  const shapes = {
    ...
    provenance: v === 'micro'
      ? '<g id="state"><path d="M5 8V5H10M14 19H19V16M8 12H16"/></g>'
      : `<g id="state"><path d="M5 9V5H10M14 19H19V15M8 12H16"/></g>${node ? '<g id="registration"><circle data-registration-node="true" cx="12" cy="12" r="1.2" fill="currentColor" stroke="none"/></g>' : ''}`,
    memory: v === 'micro'
    ...
    authority: '<g id="state"><path d="M12 4V20M4 9H9M15 15H20"/></g><g id="lineage"><path d="M9 7V11M15 13V17"/></g>',
    verification: v === 'micro'
