...
function canonicalAuthorityRequested(input = {}) {
  return input.canonicalCreativeAuthority === true
    || Boolean(input.creativeThesis)
    || Boolean(input.selectedCreativeWorld)
    || Boolean(input.creativeWorldExploration)
    || Boolean(input.styleFrameProof);
}
