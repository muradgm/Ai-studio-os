...
- path/shape geometry fingerprints and rendered per-shape bounding boxes
- layer order/membership, masks and clips
- palette/color inspection
- declared overlap relationships measured from rasterized isolated shape masks
- render comparison at 16, 32, 64 and 128 px
