...
## Purpose
Act as the senior logo designer. Convert brand strategy into proprietary visual ideas, then refine the strongest idea into a vector-ready identity system that survives real reproduction.

## When to use
- New logo or identity creation.
- Logo redesign or major refinement.
- When a generated mark has a promising idea but weak geometry, typographic relationship, or originality.

Do not use to approve the final mark; approval belongs to independent review and integrity gates.

## Inputs required
- Approved brand strategy and desired perceptions.
- Seven-type logo assessment.
- Inspiration/reference extraction with TAKE / REJECT / TRANSFORM.
- Category and confusion risks.
- Required applications and smallest reproduction size.
...
2. Assess the seven logo types and select the most credible 1–3 territories.
...
- Type shortlist with rationale.
- Concept families and variants.
- Kill criteria per family.
- Finalist construction rationale.
- Wordmark/lockup relationship.
- Responsive-mark specification.
- Motion principle derived from structure where useful.

## Review criteria
- Strategic fit and relevance.
- Distinctive silhouette and memorability.
- Simplicity appropriate to the brand, not simplicity as dogma.
- Optical quality and small-size performance.
- Wordmark compatibility.
- One-color and low-detail reproduction.
- Originality/confusion risk.
- AI-generic risk.
