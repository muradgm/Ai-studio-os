...
export function validateCreativeEngineeringBenchmark(result, expected = {}) {
  ...
  if (typeof expected.productionReady === 'boolean' && result.productionReady !== expected.productionReady) findings.push(`productionReady expected ${expected.productionReady} got ${result.productionReady}`);
