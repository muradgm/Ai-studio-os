...
function renderExecution(job) {
  ...
  setEvidenceMetric('browser', browser ? `${browser.passed}/${browser.captures}` : 'UNMEASURED', browser ? `${browser.reducedMotionCaptures} reduced-motion` : 'not run', browser ? (browser.passed === browser.captures ? 'pass' : 'fail') : 'unmeasured');
